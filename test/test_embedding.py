...
class TestEmbedding:
    ...
    def test_search_success(self, start_embedding_with_index):
        ...
        with patch('core.embeddings.faiss.normalize_L2'):
            ...
            expected_results = [('doc1', 0.9), ('doc3', 0.7)]
    ...
    def test_search_no_texts(self, start_embedding_with_index):
    ...
    def test_search_invalid_indices(self, start_embedding_with_index):
        ...
        with patch('core.embeddings.faiss.normalize_L2'):
            ...
            expected_results = [('doc1', 0.9)]
            assert results == expected_results


    def test_search_zero_k(self, start_embedding_with_index):
    ...
    def test_mean_score_success(self, start_embedding):
    ...
    def test_mean_score_no_results(self, start_embedding):
